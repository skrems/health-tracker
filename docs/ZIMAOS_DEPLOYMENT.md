...
- Image: `ghcr.io/skrems/health-tracker:v1.1.0`
- Host port: `8095`
- Container port: `80`
...
5. Confirm image `ghcr.io/skrems/health-tracker:v1.1.0`, port `8095`, and volume `/DATA/AppData/health-tracker/data:/data`.
